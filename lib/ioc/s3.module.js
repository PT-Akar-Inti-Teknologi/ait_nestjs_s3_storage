...
var AitS3Module = exports.AitS3Module = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({})];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var AitS3Module = _classThis = /** @class */ (function () {
        function AitS3Module_1() {
        }
        /* forRoot */
        AitS3Module_1.forRoot = function (options, connection) {
            var s3ConnectionProvider = {
        ...
        /* forRootAsync */
        AitS3Module_1.forRootAsync = function (options, connection) {
            var s3ConnectionProvider = {
                provide: (0, tokenizer_1.getS3ConnectionToken)(connection),
            ...
            return {
                ...
                providers: __spreadArray(__spreadArray([], this.createAsyncProviders(options, connection), true), [
        ...
        AitS3Module_1.createAsyncProviders = function (options, connection) {
        ...
        AitS3Module_1.createAsyncOptionsProvider = function (options, connection) {
            if (!(options.useExisting || options.useFactory || options.useClass)) {
                throw new Error('Invalid configuration. Must provide useFactory, useClass or useExisting');
            }
            ...
            return {
                provide: (0, tokenizer_1.getS3OptionToken)(connection),
                useFactory: function (optionsFactory) {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, optionsFactory.createS3ModuleOptions()];
                        });
                    });
                },
        ...
        return AitS3Module_1;
    }());
    __setFunctionName(_classThis, "AitS3Module");
    (function () {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        AitS3Module = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AitS3Module = _classThis;
}();
